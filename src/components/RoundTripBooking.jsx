...
const RoundTripBooking = () => {
  ...
  const calculateTotal = () => {
    // Basic logic: base rate + (hours * 500) + (km * 100) - just placeholder logic if needed, 
    // but user gave fixed rates for vehicles. Let's assume these are base rates for the minimum package.
    // For now, I'll just show the base rate or a simple multiplier.
